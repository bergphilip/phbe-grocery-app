...
<body onload="loadCart()">
    ...
    <div id="mainContentWrapper" class="main-content-wrapper">
        <input type="text" placeholder="Was möchtest du kaufen?" id="filterInput" class="input" onkeyup="searchProduct()" />
        <div id="renderListBtn" class="render-list-btn" onclick="renderList()">
            <span id="itemCounter" class="item-count"></span>
        ...
        <div class="topbar">
            ...
            <div class="sync-icon-wrapper">
                <span onclick="fetchSyncItems()" class="icon-touch-container">
                    <img id="iconSync" class="icon small sync-icons" src="../../assets/icons/sync.svg">
                </span>
                <span onclick="uploadSyncItems()" class="icon-touch-container">
                    <img id="iconCloud" class="icon large sync-icons" src="../../assets/icons/upload.svg">
                </span>
            </div>
        </div>
